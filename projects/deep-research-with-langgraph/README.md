...
![overview](notebooks/assets/complete_deep_research_flow.png)
...
cd agent-ai-projects/projects/deep-research-with-langgraph
```
...
LANGSMITH_PROJECT=deep_research_with_langgraph
```
...
#### 3. Research Supervisor (`notebooks/3_research_supervisor.ipynb`)
