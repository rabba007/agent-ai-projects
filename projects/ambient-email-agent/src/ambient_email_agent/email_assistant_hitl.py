...
from ambient_email_agent.utils import format_email_markdown, format_for_display, parse_email
...
if __name__ == "__main__":
    print(f"tools by name : {tools_by_name}")
...
def llm_call(state: State):
    ...
    return {
        "messages": [
            model_gemini_flash.bind_tools(tools=tools).invoke(
                [
...
def interrupt_handler(state: State) -> Command[Literal["llm_call", END]]:
...
email_assistant_hitl = overall_workflow.compile()
